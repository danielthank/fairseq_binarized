...
hooks.onCheckpoint = argcheck{
    ...
    call = function(engine, config, lossMeter, timeMeter, log,
        ...
        return function(state)
            ...
            log:set{time=state.t, trainLoss=stats['trainLoss'], validLoss=stats['validloss'], testLoss=stats['testloss']}
            log:flush()
            print(str2print)
            io.stdout:flush()
